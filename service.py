...
def name_analys(name, familyname, fathername):
    num_explanation = {
        ...
        7: 'Таит в себе способность направлять талант в сферу науки, в мир искусства или философии, в религиозную деятельность. Но успех их деятельности во многом зависит от глубокого анализа результатов уже достигнутого и от реального планирования своего будущего. Понимая других людей, они нередко становятся лидерами и учителями самого высокого класса. Но если они решили заняться коммерческими или финансовыми делами, то здесь им самим потребуется помощь со стороны.',
        8: 'Благоприятствует деятельности в сфере значительных, крупных дел, предвещая и материальные блага. Заканчивая успешно одно дело, эти люди сразу же принимаются за следующее. Часто пользу и выгоду, как общественный и материальный успех, им приносят увлечение забытыми учениями, брошенные предприятия, отслужившие свое методы и т.д. и т.п. Но они должны отказаться от мелочей и деталей, передавая эту работу другим, а им самим следует заниматься более значимыми делами.',
